...
function ServicesCard({ item }) {
  return (
    <div className="group relative inline-block overflow-hidden rounded border border-gray-200 hover:border-none   px-12 py-3 text-sm font-medium text-slate-800 hover:text-blue-600 focus:outline-none focus:ring  active:text-white transition duration-500 hover:-translate-y-4 hover:shadow-md hover:shadow-blue-100 ">
      ...
      <div>
        <div className="w-full py-4    ">
          <div>
            <img className="w-20 mb-4" src={item?.icon} alt="" />
          </div>
          <div>
