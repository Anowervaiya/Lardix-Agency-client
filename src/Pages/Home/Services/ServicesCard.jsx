...
function ServicesCard({ item }) {
  return (
    <div className="group relative inline-block overflow-hidden rounded border border-gray-200   px-6 py-3 text-sm font-medium text-slate-800 hover:text-blue-600 focus:outline-none focus:ring  active:text-white transition duration-500 hover:-translate-y-4 shadow-differenceCard  ">
