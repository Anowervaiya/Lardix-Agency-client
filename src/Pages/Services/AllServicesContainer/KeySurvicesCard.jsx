...
function KeySurvicesCard({ item }) {
  return (
    <div className="group relative inline-block overflow-hidden rounded border border-gray-200    px-12 py-3 text-sm font-medium text-slate-800 hover:text-blue-600 focus:outline-none focus:ring  active:text-white transition duration-500  shadow-service ">
