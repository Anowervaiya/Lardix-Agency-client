      ...
      <div className=" px-6 my-16  max-w-[1440px] mx-auto">
        ...
        <div className="flex  items-center flex-col lg:flex-row-reverse">
          <div className="flex-1">
            {' '}
            <img src="/faq.avif" className="w-full  h-[500px] lg:h-full " />
          </div>
            ...
            <div className="text-start  mx-auto lg:mx-0">
              <div className="space-y-4    *:rounded-md *:transition-all *:duration-500 *:shadow-differenceCard">
                <div className="collapse collapse-arrow">
                  ...
                  <div className="collapse-content">
                    <p className="mt-4">
                      ...
                      advertising (PPC), content marketing, influencer
                      marketing, email marketing, and analytics to help grow
                      your brand online.
                    </p>
                  </div>
                </div>

                <div className="collapse group collapse-arrow">
                ...
                <div className="collapse group collapse-arrow">
                  ...
                  <div className="collapse-content">
                    <p className="mt-4">
                      ...
                      with a focus on excellent user experience (UX) and
                ...
                <div className="collapse group collapse-arrow">
                  ...
                  <div className="collapse-content">
                    <p className="mt-4">
                      SEO is a long-term strategy, and while some improvements
                      can be seen within a few months, significant results
                      typically take 3-6 months depending on competition,
                      keywords, and the scope of the project.
                    </p>
                  </div>
                </div>
                <div className="collapse group collapse-arrow">
                  ...
                  <div className="collapse-content">
                    <p className="mt-4">
                      Yes! We specialize in both custom web development and
                      mobile app development for iOS and Android, ensuring that
                      your digital presence is consistent and user-friendly
